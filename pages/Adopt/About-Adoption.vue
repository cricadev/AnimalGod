  ...
  <div class="">
    ...
    <div class="relative h-[30vh]">
      <nuxt-img
        ...
        height="100%"
        width="100%"
        class="absolute bottom-8 left-0"
      ></nuxt-img>
      <nuxt-img
        provider="cloudinary"
      ...
      <div
        class="absolute h-[40%] w-full bg-gradient-to-t from-Bg dark:from-darkBg z-10 bottom-0 left-0 to-transparent"
      ></div>
    </div>
    <!-- DO'S AND DON'TS -->
    <div class="pt-12 px-5 flex flex-col gap-12">
      <div class="flex gap-4">
        ...
        <div class="flex flex-col gap-2">
          ...
          <p class="text-Body1sm font-regular leading-tight">
            Adopting an animal from a shelter is a wonderful way to provide a
            forever home for a needy pet. However, there are some important
            things to keep in mind before making the commitment to adopt. First
            and foremost, it is important to do your research on the animal you
            are interested in adopting. This means learning about the animal's
            behavior and history, as well as what kind of care they will need.
            Once you have done your research, it is important to visit the
            shelter to meet the animal in person. This will help you to gauge
            whether or not the animal is a good fit for your home. Finally, be
            prepared to provide the animal with a forever home. This means
            having the time, patience, and resources to provide the animal with
    ...
    <!-- PETS FOR ADOPTION -->
    <div
      class="flex flex-col gap-12 h-[70vh] w-full justify-center items-center"
    >
      ...
      <div class="flex flex-row gap-4">
        <div class="relative">
          <nuxt-img
            provider="cloudinary"
            src="/v1685134021/adoptionDog01_pybtrk.png"
            height="100%"
            width="100%"
          ></nuxt-img>
          <h6
            class="text-Heading6sm font-bold absolute bottom-2 left-1/2 translate-x-[-50%] z-10 text-Bg"
          >
            Shultz
          </h6>
          <div
            class="absolute h-[20%] w-full bg-gradient-to-t from-[#EBA5B0] bottom-0 left-0 to-transparent"
          ></div>
        </div>
        <div class="relative">
          <nuxt-img
            provider="cloudinary"
            src="/v1685134021/adoptionDog02_xbdir8.png"
            height="100%"
            width="100%"
          ></nuxt-img>
          <h6
            class="text-Heading6sm text-Bg font-bold absolute bottom-2 left-1/2 translate-x-[-50%] z-10"
          >
            Mickey
          </h6>
          <div
            class="absolute h-[20%] w-full bg-gradient-to-t from-[#EFB206] bottom-0 left-0 to-transparent"
          ></div>
        </div>
      </div>
...
ul {
  list-style: none;
  li {
    @apply text-Body1sm font-regular my-2 leading-tight;
  }
}
.first-list {
  li::before {
    content: url("https://res.cloudinary.com/ddc0cce3m/image/upload/v1685132187/checkGreen_r6qaq1.png");
    margin-right: 1rem;
...
.second-list {
  li::before {
    content: url("https://res.cloudinary.com/ddc0cce3m/image/upload/v1685132236/checkRed_vpapp0.png");
    margin-right: 1rem;
    display: inline-block;
  }
}
