<template>
  <div class="flex justify-between mx-5 items-center">
    <USelectMenu placeholder="Animal" v-model="selected" :options="people" id="select-menu" ref="selectMenu" :ui="{
  ...
  default: {
    ...
    <UButton size="xl" label="Filter by" color="primary" variant="solid" trailingIcon="i-mdi-menu-down" :ui="{
      color: {
        contAccent: {
          solid:
