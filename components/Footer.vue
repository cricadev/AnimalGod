  ...
  <div class="h-screen bg-Bg dark:bg-darkBg w-full grid grid-cols-3 grid-rows-6 px-5 place-items-center">
    ...
    <div class="col-start-1 col-end-4 row-start-4 row-end-7 mt-10">
      ...
      <div class="flex flex-row justify-center items-center w-full">
        <UInput color="white" variant="outline" size="sm" placeholder="Email" class="" :ui="{
        ...
        <UButton size="sm" label="Subscribe" color="primary" class="rounded-r-md rounded-l-none" variant="solid" :ui="{
          size: {
            sm: 'text-Captionsm',
          },
          padding: {
